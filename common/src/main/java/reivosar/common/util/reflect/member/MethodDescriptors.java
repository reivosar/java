...
public interface MethodDescriptors extends ExecutableClassMemberDescriptors<MethodDescriptor> {
     ...
     * @param parameterTypes the parameterTypes of the methods to filter by
     * @return a new instance of {@code MethodDescriptors} containing only the matching methods
     */
    MethodDescriptors filter(String name, Class<?>... parameterTypes);
     ...
     * @return a new instance of {@code MethodDescriptors} containing only the matching methods
     */
    MethodDescriptors filter(Class<? extends Annotation> annotationClass, Class<?>... parameterTypes);
