...
import reivosar.modeling.ticket.domain.model.audience.type.NormalAudience;
...
class NormalAudienceTest extends AudienceTestTemplate<NormalAudience>
{
	...
	class 平日 extends AudienceTestTemplate.平日 {
		@Test
		void 時間が1959の場合() {
			assertThat(getAudience().calcScreenPrice(scheduledTime_1959), is(getAssertionPrice(1800)));
		}
		@Test
		void 時間が2000の場合() {
